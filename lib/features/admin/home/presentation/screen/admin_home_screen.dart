...
import 'package:ecommerce_app/features/admin/add_categories/presentation/screen/add_categories_screen.dart';
import 'package:ecommerce_app/features/admin/add_products/presentation/screen/add_products_screen.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                setState(() {
                  currentScreen = AddCategoriesScreen();
                });
                context.pop();
              },
            ),
            ListTile(
              ...
              onTap: () {
                setState(() {
                  currentScreen = AddProductsScreen();
                });
                context.pop();
              },
            ),
